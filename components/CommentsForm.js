...
const CommentsForm = ({ slug }) => {
   ...
   useEffect(() => {
      setLocalStorage(window.localStorage); //VO react ne mora window da ima pred. vo NEXT mora
...
//    //Vo o voj slucaj ne pravime graphQl request tuku
//    submitComment(commentObj)
//       .then((res) => {
//          if (res.createComment) {
//             if (!storeData) {
...
//       </div>
//       <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
//          <input type="text" ref={nametEl} onChange={onInputChange} className="py-2 px-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700" placeholder="Name" name="name" />
...
//       <div className="grid grid-cols-1 gap-4 mb-4">
//          <div>
//             <input ref={storeDataEl} onChange={onInputChange} type="checkbox" id="storeData" name="storeData" value="true" />
//             <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Save my name, email in this browser for the next time I comment.</label>
//          </div>
//       </div>
//       {error && <p className="text-xs text-red-500">All fields are mandatory</p>}
